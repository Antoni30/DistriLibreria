...
import edu.espe.notificaciones.exeptions.CustomAccessDeniedHandler;
import edu.espe.notificaciones.security.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/notificaciones").hasRole("ADMINISTRADOR")
